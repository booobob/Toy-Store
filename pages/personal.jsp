...
<body>
    ...
    <section>
		...
		<%
		//String objname = session.getAttribute("ID");
		String objname="1";
		...
		String sql,id;
		ResultSet rs;
		sql="select * from toy.member where `userID`= "+objname;
            ...
            <div id="tab-inner" class="">
                <form class="form-content" id=tab1 action="change.jsp">
                    ...
                    <div class="click">
                        ...
                        <button class="btnbuy" formaction="logout.jsp">登出</button>    
                    </div>  
                    <hr>
                ...
                <form class="form-content" id=tab2 action="pwchange.jsp" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="checkpassword" id="checkpassword" onchange="if(document.getElementById('newpassword').value!=document.getElementById('checkpassword').value){setCustomValidity('密碼不吻合');}"/>
                        <i class="fa fa-eye-slash"></i>
                    </div>
                    <div class="click">
